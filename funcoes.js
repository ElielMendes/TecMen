...
function vaiP6() { window.location.href = "pagina6.html"; }
function vaiP3() {
  if( getUser() != "" ) window.location.href = "pagina3.html";
...
function setUser() { // Cria o cookie com as chaves "username" e expires
  let userid = "username=" + document.getElementById( "username" ).value;
